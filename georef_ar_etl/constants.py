...
class CensusBlockINDECType(Enum):
    U = 'Urbano'
    R = 'Rural'
    M = 'Mixto'
...
CENSUS_BLOCK_INDEC_TYPES = {
    member.name: member.value
    for member in list(CensusBlockINDECType)
}
...
ANTARCTIC_BASES = 'bases_antarticas'
HAMLETS = 'parajes'
ENTITIES = 'entidades'
...
AGGLOMERATIONS_ETL_TABLE = ETL_TABLE_NAME.format(AGGLOMERATIONS)
CENSUS_TRACTS_ETL_TABLE = ETL_TABLE_NAME.format(CENSUS_TRACTS)
CENSUS_BLOCKS_ETL_TABLE = ETL_TABLE_NAME.format(CENSUS_BLOCKS)
...
EDUCATIONAL_INSTITUTIONS_ETL_TABLE = ETL_TABLE_NAME.format(EDUCATIONAL_INSTITUTIONS)
UNIVERSITY_INSTITUTIONS_ETL_TABLE = ETL_TABLE_NAME.format(UNIVERSITY_INSTITUTIONS)
...
ANTARCTIC_BASES_TMP_TABLE = TMP_TABLE_NAME.format(ANTARCTIC_BASES)
HAMLETS_TMP_TABLE = TMP_TABLE_NAME.format(HAMLETS)
ENTITIES_TMP_TABLE = TMP_TABLE_NAME.format(ENTITIES)
CENSUS_LOCALITIES_TMP_TABLE = TMP_TABLE_NAME.format(CENSUS_LOCALITIES)
AGGLOMERATIONS_TMP_TABLE = TMP_TABLE_NAME.format(AGGLOMERATIONS)
CENSUS_TRACTS_TMP_TABLE = TMP_TABLE_NAME.format(CENSUS_TRACTS)
CENSUS_BLOCKS_TMP_TABLE = TMP_TABLE_NAME.format(CENSUS_BLOCKS)
...
EDUCATIONAL_INSTITUTIONS_TMP_TABLE = TMP_TABLE_NAME.format(EDUCATIONAL_INSTITUTIONS)
UNIVERSITY_INSTITUTIONS_TMP_TABLE = TMP_TABLE_NAME.format(UNIVERSITY_INSTITUTIONS)
